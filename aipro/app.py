...
app.config["MAIL_USERNAME"] = "rithvikbng@gmail.com"  # Replace with your email
app.config["MAIL_PASSWORD"] = "qgqbcemyghkxmshq"  # Replace with your app password
app.config["MAIL_DEFAULT_SENDER"] = "rithvik.22ece@cambridge.edu.in"

mail = Mail(app)

# Paths 
TEMPLATE_PATH = os.path.join("static", "Beige and Green Floral Appreciation Certificate.png")
FONT_PATH = os.path.join("static", "Vintage.otf")
